    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-serif font-bold text-oxford text-center mb-8">Why Partner With Us</h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
              <div className="text-4xl">💰</div>
              <div className="font-semibold text-oxford mt-4">Recurring Revenue</div>
              <p className="text-slate-500 mt-2">Earn ongoing commissions for every client you refer.</p>
            </div>
            <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
              <div className="text-4xl">🤝</div>
              <div className="font-semibold text-oxford mt-4">Dedicated Support</div>
              <p className="text-slate-500 mt-2">Your clients get white-glove onboarding and support.</p>
            </div>
            <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
              <div className="text-4xl">📈</div>
              <div className="font-semibold text-oxford mt-4">Market Growth</div>
        ...
        {/* Tiers */}
        <section className="mb-12">
          <h2 className="text-2xl font-serif font-bold text-oxford text-center mb-8">Partner Tiers</h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            {partnerTiers.map((tier, i) => (
              <div key={i} className={`bg-white rounded-xl shadow-sm border p-6 ${i === 1 ? 'border-[#D4AF37] border-2' : ''}`}>
                {i === 1 && (
                  <div className="bg-[#D4AF37] text-oxford text-xs font-semibold px-3 py-1 rounded-full inline-block mb-4">
                    MOST POPULAR
                  </div>
                )}
                <h3 className="text-xl font-semibold text-oxford">{tier.name}</h3>
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  <div className="text-sm font-medium text-oxford">Requirement</div>
        ...
        {/* Testimonials */}
        <section className="mb-12">
          <h2 className="text-2xl font-serif font-bold text-oxford text-center mb-8">Partner Success Stories</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, i) => (
              <div key={i} className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="mt-4">
                  <div className="font-semibold text-oxford">{testimonial.author}</div>
        ...
        {/* Process */}
        <section className="mb-12">
          <h2 className="text-2xl font-serif font-bold text-oxford text-center mb-8">How to Become a Partner</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 bg-white rounded-xl shadow-sm border p-6">
              ...
              <div>
                <div className="font-semibold text-oxford">Apply Online</div>
            ...
            <div className="flex items-center gap-4 bg-white rounded-xl shadow-sm border p-6">
              ...
              <div>
                <div className="font-semibold text-oxford">Review Call</div>
            ...
            <div className="flex items-center gap-4 bg-white rounded-xl shadow-sm border p-6">
              ...
              <div>
                <div className="font-semibold text-oxford">Onboarding</div>
        ...
        <section className="bg-[#002147] text-white rounded-xl p-12 text-center">
          ...
          <form className="mt-8 max-w-md mx-auto space-y-4">
            <input 
              ...
              className="w-full px-4 py-3 text-oxford rounded-md"
            />
            <input 
              type="text" 
              ...
              className="w-full px-4 py-3 text-oxford rounded-md"
            />
            <button className="w-full px-6 py-3 bg-[#D4AF37] text-oxford rounded font-semibold hover:bg-[#b8962f]">
              Apply Now
            </button>
          </form>
        </section>
